function [diam_ind, def_ind, mean_diam] = LatB_prep(sets_headers, sets_col)
...
diam_ind = [
    ...
    find(~cellfun(@isempty, strfind(sets_headers{3}, 'Diameter_um')));
    ];
...
%Diameter_um  - size in the direction perpendicular to flow +/- 30 deg [um];
